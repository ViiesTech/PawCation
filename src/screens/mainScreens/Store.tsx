...
import { currentLoc, filter, notification, pin, plus, rating, search, search2 } from '../../assets/icons'
...
const Home = ({navigation}) => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ flexGrow: 1, paddingHorizontal: responsiveHeight(1), paddingVertical: responsiveHeight(2), backgroundColor: Colors.white }}>
      <View style={{ backgroundColor: '#818AF9', marginBottom: responsiveHeight(2), paddingHorizontal: responsiveHeight(1), paddingTop: responsiveHeight(2), borderRadius: responsiveHeight(2) }}>
        <Header handlePress={()=>navigation.navigate('Location')} whiteNotification={true} bgColor={'#A7ADFB'} />
        <View style={{ backgroundColor: '#C9D1FF', width: '100%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', height: responsiveHeight(6.5), paddingHorizontal: responsiveHeight(2), borderRadius: 10, marginTop: responsiveHeight(2.5), gap: responsiveHeight(2) }}>
          <TouchableOpacity>
            <SvgIcons xml={search2} height={'20'} width={'20'} />
          </TouchableOpacity>
          <TextInput style={{ flex: 1, color: '#fff' }} placeholderTextColor={'#fff'} placeholder='Find best Hotels and Pet Care' />
        </View>
...
Text.'/>
            <Button alignSelf='left' height={responsiveHeight(5)} width={responsiveHeight(11)} textColor={Colors.white} bgColor='#8079DD' title='See All' />
          </View>
